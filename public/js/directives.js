  ...
  .directive('player', function () {
    return {
      ...
      link: function (scope, elem, attr) {
        scope.colors = ['#7CE4E8', '#c80161', '#FC575E', '#F2ADFF', '#398EC4', '#8CFF95'];
      }
    };
            ...
            */
            keyup: function (editor, event) {
              if (event.key === 'Enter' && !event.shiftKey) {
                ...
                const message = $('#emojionearea2').emojioneArea()[0].emojioneArea.getText();
                scope.sendMessage(message);
                $('#emojionearea2').emojioneArea()[0].emojioneArea.setText('');
              }
            }
          }
        });
